...
| Backend examine accepts 8 planar + `here` (vertical excluded, `allow_vertical=false`) | `src/arcopolis_command.cpp` `examine_direction_answers`; `src/game.cpp` `game::examine`                                                              |
