...
| Arcopolis vertical command          | `vertical_move` verb → `ACTION_MOVE_DOWN`/`UP` → native `game::vertical_move`; IMPLEMENTED Spike 24 (`src/arcopolis_command.cpp:71-83,272-288`)                                                       | NEEDS NEW SEAM                                                                        | n/a              | **Yes** — drivable matched-stair, level 2/3 (Spike 24, doc 49).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
